...
declare type DatabaseId = string | [string];
declare type TableId = string | [string] | [string, string];
declare type ColumnId = string | [string] | [string, string] | [string, string, string];
declare type UnescapedId = ColumnId;
